    ...
    public function getContent() {
        ...
        if(isset($_GET['email']) && isset($_GET['password'])) {
            ...
            if($auth->num_rows == 1) {
                ...
                echo "<meta http-equiv='Refresh' content='0; URL=".URI."/buy_elly/'>Если перенаправление не произошло, нажмите <a href='".URI."/buy_elly/'>сюда</a>";
                redirect(URI . "/buy_elly/");
            }
            else {
