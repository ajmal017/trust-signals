...
<div class="row" style="position: relative;">
	<div class="web-binomo-auth-wrap %auth%">
		<div class="web-binomo-auth">
			<h1 style="    padding-bottom: 0;">Авторизация Binomo</h1>
			<span>	Мы не сохраняем Ваши пароли!</span>
			<div class="web-binomo-auth-box">
				<div class="form-group">
					<input type="text" class="web-binomo-login form-control"  placeholder="Логин" />
				</div>
				<div class="form-group">
					<input type="password" class="web-binomo-password form-control"  placeholder="Пароль" />
				</div>
		<a href="" onclick="window.open('https://youtu.be/kvHT4ENGUQs', 'width=900, height=900 scrollbars=yes'); return false;" style="font-size: 17px;">Где получить эти данные <i class="fa fa-youtube" aria-hidden="true"></i></a>
				<div class="form-group">
					<input type="text" class="web-binomo-authtoken form-control"  placeholder="Введите Authtoken" />
				</div>
				<div class="form-group">
					<input type="text" class="web-binomo-device-id form-control"  placeholder="Введите DeviceId" />
				</div>
				<div class="form-group">
					<button class="web-binomo-btn btn btn-warning">Войти</button>
				</div>
				<a href="https://binomo.com?a=dfc065d57843&ac=vhodbot" target="_blank"><button class=" btn btn-info" style="
    color: #404040;
    font-weight: 600;
    padding: 10px;
">Открыть платформу Binomo <i class="fa fa-chevron-right" aria-hidden="true"></i></button></a>
			</div>
		</div>
	</div>
	<div class="web-info col-md-12">
		...
		<ol>
			<li>Выберете тип счета (демо/реальный)</li>
			<li>Настройте робота</li>
			<li>Нажмите "Запустить"</li>
			<li>Остались вопросы? - <a target="_blank" href="%URI%/faq-elly/">перейдите сюда</a></li>
			<p><b class="web-chrome-info">Для оптимальной работы робота используйте Google Chrome</b></p>
		</ol>
		<div class="web-change-box"><button class="web-change-account">Сменить аккаунт Binomo</button></div>
						...
						<div class="panel-footer">
							<div class="form-group">
								...
								<div class="width-100-percent input-group">
									<select class="width-100-percent web-set-balance-type form-control">
