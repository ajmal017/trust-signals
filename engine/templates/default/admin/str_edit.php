...
<button data-id="%id%" class="btn btn-default" id="load-img-str"><span class="glyphicon glyphicon-picture"></span> Загрузить картинку</button>
...
<div class="form-group">
    <button data-id="%id%" id="edit-str" class="btn btn-info">Сохранить</button>
</div>
...
<script type="text/javascript">
    $(document).ready(function() { CKEDITOR.replace("edit-desc"); });
</script>