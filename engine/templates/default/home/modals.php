...
<div class="modal fade" id="rules-modal" tabindex="-1" role="dialog" aria-labelledby="rules-modal-label">
    <div class="modal-dialog" role="document">
     ...
     <p>2 | Любое использование, как любой из частей, так и всего программного комплекса приема торговых сигналов, тестирования торговых стратегий "Trust Signals" и программных продуктов на его базе (далее «Сервис»), допустимо только в полном принятии настоящих Правил оказания услуг (далее Правила).</p>
